...
public class MailNotification {
    /**
     * code found at: https://stackoverflow.com/questions/3649014/send-email-using-java
     */
    //Takes the inputs needed to login to gmail as well as who you want to send the mail to,
    ...
    public static void Send(final String username, final String password, String recipientEmail,
        ...
        //Sets the properties so that mails can be sent
        //through gmails server
        ...
        props.setProperty("mail.smtps.auth", "true");
            ...
            /*
                ...
                reference: http://java.sun.com/products/javamail/javadocs/com/sun/mail/smtp/package-summary.html
